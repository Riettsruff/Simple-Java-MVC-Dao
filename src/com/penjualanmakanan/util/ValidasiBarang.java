...
public class ValidasiBarang extends ValidasiForm {
     ...
     *
     * @param target ini parameter array list target
    ...
    private boolean isNamaValid() {
        return isRequiredValid(namaLabel, namaValue)
    ...
    private boolean isStokValid() {
        return isRequiredValid(stokLabel, stokValue)
    ...
    private boolean isHargaValid() {
        return isRequiredValid(hargaLabel, hargaValue)
